...
argparser.add_argument(
    "--encoder_model",
    type=str,
    default="output_models/sam2_hiera_small.encoder.onnx",
    help="Path to the ONNX encoder model",
)
argparser.add_argument(
    "--decoder_model",
    type=str,
    default="output_models/sam2_hiera_small.decoder.onnx",
...
prompt = [
    {"type": "point", "data": [100, 100], "label": 1},
]

embedding = model.encode(image)
# print("encoded image")
# print(embedding['image_embedding'].shape)
# print(embedding['image_embedding'])
